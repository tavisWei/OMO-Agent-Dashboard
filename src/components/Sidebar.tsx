...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { path: ROUTES.WORKBOARD, label: t('nav.workboard'), icon: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7' },
    ...
    { path: ROUTES.ANALYTICS, label: t('nav.analytics'), icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6m6-6V5a2 2 0 012-2h2a2 2 0 012 2v8m6-6v12a2 2 0 002 2h2a2 2 0 002-2v-12M3 5a2 2 0 012-2h2a2 2 0 012 2v2H3V5z' },
